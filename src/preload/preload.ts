...
contextBridge.exposeInMainWorld("auth", {
    loginWithEmail: (email: string, password: string) => ipcRenderer.invoke("login:email", email, password),
    loginWithGoogle: () => ipcRenderer.invoke("login:google"),
    loginWithGithub: () => ipcRenderer.invoke("login:github"),
    loginAnonymously: () => ipcRenderer.invoke("login:anonymous"),
});
