...
function handleIpcEvents(mainWindow) {
    electron_1.ipcMain.on("close-window", () => mainWindow === null || mainWindow === void 0 ? void 0 : mainWindow.close());
    electron_1.ipcMain.on("minimize-window", () => mainWindow === null || mainWindow === void 0 ? void 0 : mainWindow.minimize());
    ...
    electron_1.ipcMain.on("toggle-devtools", () => mainWindow.webContents.toggleDevTools());
}
